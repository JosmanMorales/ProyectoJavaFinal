...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/save-water.png"))); // NOI18N

        jLabel6.setText("╰•★★ PURIFICADORA \"FUENTE BELLA\" ★★•╯");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            Usuarios modSql = new Usuarios();
            users mod = new users();

            if (!txtUsuario.getText().equals("") && !JPasswordField1.getText().equals("")) {
                mod.setUsuario(txtUsuario.getText());
                mod.setPass(JPasswordField1.getText());  

                if (modSql.login(mod)) {
                    this.dispose();
                    crud frmHome = new crud();
